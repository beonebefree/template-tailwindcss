 ...
 */}
                        ...
                        <div className="sm:col-span-4">
                            <div className="mt-2">
                                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                    <span className="flex select-none items-center pl-3 text-gray-700 sm:text-sm">Vendedor/</span>
                                    <input value={nameSeller} onChange={(e) => setNameSeller(e.target.value)} type="text" name="username" id="username"  className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="Franco" />
                                </div>
                            </div>
                        </div>
                ...
                <div className="border-b border-gray-900/10 pb-12">
                    ...
                    <p className="mt-1 text-sm leading-6 text-gray-800">Complete los datos específicos para que el cliente pueda ser contactado correctamente.</p>
                    ...
                    <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        {/* <div class="col-span-full">
                            <label for="country" class="block text-sm font-medium leading-6 text-gray-900">Localidad</label>
                            <div class="mt-2">
                        ...
                        <div className="col-span-full">
                            <label htmlFor="region" className="block text-sm font-medium leading-6 text-gray-900">Teléfono</label>
                            <div className="mt-2">
                        ...
                        <div className="col-span-full">
                            ...
                            <p className="mt-3 text-sm leading-6 text-gray-700"> Cuentanos para qué usarias tu página web.</p>
                        </div>
                ...
                <div className="border-b border-gray-900/10 pb-12">
                    ...
                    <p className="mt-1 text-sm leading-6 text-gray-700">¿Qué medio prefieres que usemos para contactarte?</p>
                            ...
                            <div className="mt-6 space-y-6">
                                <div className="relative flex gap-x-3">
                                    ...
                                    <div className="text-sm leading-6">
                                        ...
                                        <p className="text-gray-700">Get notified when someones posts a comment on a posting.</p>
                                    </div>
                                </div>
                                <div className="relative flex gap-x-3">
                                    <div className="flex h-6 items-center">
                                    ...
                                    <div className="text-sm leading-6">
                                        ...
                                        <p className="text-gray-700">Get notified when a candidate applies for a job.</p>
                                    </div>
                                </div>
                                <div className="relative flex gap-x-3">
                                    <div className="flex h-6 items-center">
                                    ...
                                    <div className="text-sm leading-6">
                                        ...
                                        <p className="text-gray-700">Get notified when a candidate accepts or rejects an offer.</p>
                                    </div>
                                </div>
                            </div>
                        </fieldset>
